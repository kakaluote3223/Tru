    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDriverRuleBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //展示注册司机条款界面
                Intent intent = new Intent(DriverRegisterActivity.this,DriverRuleShowActivity.class);
        ...
        mRegisterDriverInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                registerDriver();
                //跳转到司机登录界面
                Intent intent = new Intent(DriverRegisterActivity.this, DriverAvailableOrderShowActivity.class);
